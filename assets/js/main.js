...
! function (i) {
    ...
    i("#preloader").fadeOut("normall", function () {
        ...
        e <= 50 ? (i("header").removeClass("scrollHeader").addClass("fixedHeader"), a.attr("src", "assets/img/logos/logo-inner.png")) : (i("header").removeClass("fixedHeader").addClass("scrollHeader"), a.attr("src", "assets/img/logos/logo.png")), t.attr("src", "assets/img/logos/logo.png"), o.attr("src", "assets/img/logos/logo.png")
    }), s.on("scroll", function () {
